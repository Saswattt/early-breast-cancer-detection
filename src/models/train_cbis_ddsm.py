...
DATA_DIR = os.path.join(BASE_DIR, 'data/processed/CBIS-DDSM')
...
def train_model():
    ...
    history = model.fit(
        ...
        callbacks=[
            ...
            tf.keras.callbacks.ModelCheckpoint(
                os.path.join(model_dir, 'cbis_ddsm_model_best.h5'),
                save_best_only=True,
    ...
    # Save final model
    model.save(os.path.join(model_dir, 'cbis_ddsm_model_final.h5'))
